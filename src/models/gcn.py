"""
gcn.py — GCN baseline (Kipf & Welling, ICLR 2017).

mode="3d"      — текущий режим: radius-graph + 3D edge features (RBF)
mode="2d_pure" — граф из SMILES, признаки только из топологии, без 3D
"""
import torch
...
class GCNSigmaModel(nn.Module):
    def __init__(
        ...
        mode:         str   = "2d_pure",    # "3d" или "2d_pure"
    ):
        super().__init__()
        self.hidden = hidden
        # node_feat_dim возвращает 15 (3d extended), 7 (3d base) или 14 (2d_pure)
